 ...
 */
function feel4photos_custom_colors_css() {
	 ...
	 */
	$saturation = absint( apply_filters( 'feel4photos_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.feel4photos-front-page) .entry-title,
...
.colors-custom .feel4photos-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.feel4photos-front-page .panel-content .recent-posts article,
...
.colors-custom.feel4photos-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	 ...
	 */
	return apply_filters( 'feel4photos_custom_colors_css', $css, $hue, $saturation );
}
